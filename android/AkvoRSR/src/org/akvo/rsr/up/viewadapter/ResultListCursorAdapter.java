...
public class ResultListCursorAdapter extends CursorAdapter{
 ...
 */
	...
	public ResultListCursorAdapter(Context context, Cursor cursor) {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		dateView.setText(mDateformat.format(d));
